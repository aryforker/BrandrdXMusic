...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/aryforker/BrandrdXMusic",
)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "maina")
GIT_TOKEN = getenv(
    "GIT_TOKEN", None
...
SONG_DOWNLOAD_DURATION = int(getenv("SONG_DOWNLOAD_DURATION_LIMIT", "320"))
SONG_DOWNLOAD_DURATION_LIMIT = int(getenv("SONG_DOWNLOAD_DURATION_LIMIT", "320"))
